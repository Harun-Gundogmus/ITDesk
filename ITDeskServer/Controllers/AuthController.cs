...
//[AllowAnonymous]
//public class AuthController(ApplicationDbContext context, UserManager<AppUser> usermanager, SignInManager<AppUser> signInManager, JwtService jwtService) : ApiController
//{
...
//            {
//                return BadRequest(new { Message = $"Kullanıcınız 3 kere yanlış şifre girişinden dolayı {Math.Ceiling(timeSpan.Value.TotalMinutes)} bu tarihe kadar kilitlenmiştir." });
//            }
//            else
//            {
//                return BadRequest(new { Message = $"Kullanıcınız 3 kere yanlış şifre girişinden dolayı 15 bu tarihe kadar kilitlenmiştir." });
//            }
//        }
...
//        var roles = context.AppUserRoles
